  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        ...
        <span class="span">LIFE FITNESS</span>
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="fitness..html" class="navbar-link">fitness Calculator</a>
          </li>
      ...
      <a href="index.php" class="btn btn-secondary">Admin</a>
      ...
      <section class="section hero bg-dark has-after has-bg-image" id="home" aria-label="hero" data-section
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            LF opened its doors for all the fitness enthusiasts has successfully produced thousands of personal trainers and health coaches.
            </p>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="section-text">
              Life Fitness 24x7 Started its journey in 2016 with the concept of 24x7 facility with in area of 8000 sq.ft in single floor. Our Moto is to provide worldclass health facility with best health equipments.

            </p>

            <p class="section-text">
              Through Transform, we help you pull out all the stops that you from actualizing your dream of becoming and staying the fitter you. We know that there’s no ‘one size fits all’ when it comes to exercising, which is why we focus on a tailored approach that is carefully planned considering your body, dietary needs, limitations, and injuries. We take workouts really seriously and for this very reason we impel you to push your fitness limits by providing you the expert guidance of best trainers and top of the line machinery. Additionaly, we offer High-Intensity Interval Training (HIIT) workouts for building strength, stamina, fitness, and flexibility.
            </p>
  ...
  <footer class="footer" id="footer">
      ...
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            ...
            <span class="span">life<br>fitness</br></span>
          </a>
        ...
        <ul class="footer-list">
          ...
          <li class="footer-list-item">
            ...
            <address class="address footer-link">
              1247/Plot No. 39, 15th Phase,raipur
            </address>
          </li>
          ...
          <li class="footer-list-item">
            ...
            <div>
              ...
              <a href="tel:+918827348263" class="footer-link">+91 8827348263</a>
            </div>
          </li>
          ...
          <li class="footer-list-item">
            ...
            <div>
              <a href="mailto:info@lifefitness.com" class="footer-link">info@lifefitness.com</a>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-title has-before">social-list</p>
          </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022 lifefitness. All Rights Reserved By <a href="#" class="copyright-link">Bhumika</a>
        </p>
